...
public class EditorActivity extends AppCompatActivity implements
    ...
    private void saveShop() {
        ...
        values.put(ShopEntry.COLUMN_SUPPLIER_NAME,supplierString);
        values.put(ShopEntry.COLUMN_QUANTITY,quantityString);
        values.put(ShopEntry.COLUMN_SUPPLIER_PHONE_NUMBER,phoneString);
    ...
    public Loader<Cursor> onCreateLoader(int i, Bundle bundle) {
        ...
        return new CursorLoader(this,   // Parent activity context
                mCurrentShopUri,         // Query the content URI for the current pet
